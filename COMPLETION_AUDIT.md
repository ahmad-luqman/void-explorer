...
| Improved clouds | Shaded shell and 16 rounded cloud banks, bounded 24,000 triangles; flat bases removed | Improved shape/underside lighting and broader filtered orbital weather; local cloud edges/integration still fall short of the concept |
...
| Terrain-streaming refinement | Predictive workers; worker-prepared contact normals/seams; 35.8 km / 30 s measured traversals and cached-route samples on both renderers | Main-thread patch preparation reduced and sustained load behavior measured. Independent terrain-region refinement and the stretched distant contact grid remain incomplete |
...
| Release | Private Sites build v29 published successfully; 116 tests; standard WebGPU shader fix, dual-renderer terrain/storage and production journeys, measured sustained streaming and cached repeats; prior authored-site, route and desktop-engine coverage retained | Intermediate release delivered; full visual/device acceptance and remaining game requirements are still open |
...
Latest verified private publication: 17 September 2026 local time, Sites version 29, source subtree commit `51d8703486c99987c6d15331e4e8cfdd8042c2fa`. Deployment reported `succeeded`. The public GitHub origin was not pushed. The next work is independent terrain-region refinement, followed by foreground/distant terrain, cloud/shoreline integration and the remaining hardware-validation requirements above.
