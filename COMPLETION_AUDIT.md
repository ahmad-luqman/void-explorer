...
| Release | Private Sites build v27 published successfully; 109 tests; final orbital/coastal/route journeys, touch checks, Firefox/WebKit route checks and M4 Max frame-pacing baseline | Intermediate release delivered; full visual/device acceptance and remaining game requirements are still open |
