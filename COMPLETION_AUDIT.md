...
| Terrain-streaming refinement | Predictive workers, whole-patch morphing/caches | Incomplete: stronger streaming continuity and measured load/stall behavior. Stretched-cell lighting now suppresses dense stripes; cloud/ring filtering reduces the distant pattern aliasing found during flight review |
