...
| Release | Private Sites build v28 published successfully; 115 tests; authored-site survey/return journeys, final orbital/coastal/route journeys, touch checks, Firefox/WebKit route checks and M4 Max frame-pacing baseline | Intermediate release delivered; full visual/device acceptance and remaining game requirements are still open |
...
Latest verified private publication: 17 September 2026 local time, Sites version 28, source subtree commit `a8813343fb434458a4017d08de4ebe48274fcd06`. Deployment reported `succeeded`. The public GitHub origin was not pushed. The next work is sustained terrain-streaming measurement and refinement, followed by foreground/distant terrain, cloud/shoreline integration and the remaining hardware-validation requirements above.
